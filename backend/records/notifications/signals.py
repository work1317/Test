...
def create_notification_on_patient_save(sender, instance, created, **kwargs):
    print("Signal Triggered for patient:", instance.patient_id)
    Notification.objects.create(
        title="New Patient Registered" if created else "Patient Updated",
        message=f"Patient with ID {instance.patient_id} and name {instance.patient_name} has been {'registered' if created else 'updated'}.",
