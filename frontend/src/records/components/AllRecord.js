...
//           axios.get(`http://127.0.0.1:8000/records/records/?record_type=vitals&patient_id=${selectedPatient.patient_id}`, {
//             params: { patient_id: selectedPatient.patient_id, record_type: 'vitals' }
//           }),
//           axios.get(`http://127.0.0.1:8000/records/records/?record_type=prescription&patient_id=${selectedPatient.patient_id}`, {
//             params: { patient_id: selectedPatient.patient_id, record_type: 'prescription' }
//           }),
//           axios.get(`http://127.0.0.1:8000/records/records/?record_type=service_procedure&patient_id=${selectedPatient.patient_id}`, {
