...
const ScheduleAppointments = ({ show, handleClose}) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} centered size="lg">
      <Modal.Header closeButton><Modal.Title>Schedule New Appointment</Modal.Title></Modal.Header>
      <Modal.Body>
        ...
        <Form onSubmit={handleSubmit} className="p-3">
          <Row className="mb-3">
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Control type="text" name="patient_name" value={formData.patient_name} onChange={handleChange} isInvalid={!!error.patient_name} />
            ...
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Control type="text" name="doctor" value={formData.doctor_name} onChange={handleChange} isInvalid={!!error.doctor} />
          ...
          <Row className="mb-3">
            <Col md={6}>
              <Form.Group>
                ...
                <InputGroup>
                  <Form.Control type="tel" name="phno" value={formData.phno} onChange={handleChange} autoComplete="off" isInvalid={!!error.phno} />
            ...
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Control type="email" name="email" value={formData.email} onChange={handleChange} isInvalid={!!error.email} />
          ...
          <Row className="mb-3">
            <Col xs={12} md={4}>
              <Form.Group>
                ...
                <InputGroup>
                  <Form.Control type="number" name="age" value={formData.age} onChange={handleChange} isInvalid={!!error.age} />
            ...
            <Col md={4}>
              <Form.Group>
                ...
                <InputGroup>
                  <Form.Control type="time" name="time" value={formData.time} onChange={handleChange} isInvalid={!!error.time} />
          ...
          <Row className="mb-3">
            ...
            <Col md={4}>
              <Form.Group>
                ...
                <InputGroup>
                  <Form.Control type="date" name="date" value={formData.date} onChange={handleChange} isInvalid={!!error.date} />
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control as="textarea" rows={3} name="notes" value={formData.notes} onChange={handleChange} placeholder="Add additional notes..." isInvalid={!!error.notes} />
