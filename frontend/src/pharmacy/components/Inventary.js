      ...
      try {
        ...
        if (response.status === 200 && response.data.success === 1) {
          ...
          const uniqueCategories = [
            ...new Set(meds.map((med) => med.category)),
          ];
    ...
    <div>
      {loading ? (
        ...
        <>
          ...
          <div
            className={
              filteredMedications.length > 6 ? styles.scrollContainer : ""
            }
            style={{
                    ...
                    <div className={styles.main}>
                      <div className={`p-3 ${styles.card}`}>
                        <Row className="d-flex justify-content-between align-items-center mb-3">
                          <Col>
                            <span
                              style={{ fontSize: "18px", color: "#313131" }}
                            >
                              {med.medication_name}
                            </span>
                          ...
                          <Col className="text-end">
                            <span
                              ...
                              style={{
                                color:
                                  med.status_alert === "Low Stock"
                                    ? "#CC931C"
                                    : med.status_alert === "In Stock"
                                    ? "#16A34A"
                                    : med.status_alert === "Stagnant"
                                    ? "#F8A401"
                                    : med.status_alert === "Nearing Expiry"
                                    ? "#FF0004"
                                    : med.status_alert ===
                                ...
                                ...(med.status_alert ===
                                  ...
                                  padding: "2px 6px",
                                  borderRadius: "4px",
                                  minWidth: "120px", // ⬅️ Ensures alignment consistency
                                }),
                              }}
                            >
                              {med.status_alert}
                        ...
                        <Row className="d-flex justify-content-between align-items-center mb-3">
                          ...
                          <Col className="text-end">
                            {" "}
                            <span>{med.stock_quantity} tablets</span>{" "}
                          </Col>
                        </Row>
                        <Row className="d-flex justify-content-between align-items-center mb-3">
                          <Col>
                        ...
                        <Row className="d-flex justify-content-between align-items-center mb-3">
                          <Col>
                            {" "}
                            <span className="text-muted">Batch No</span>
                          </Col>
                          <Col className="text-end">
                            <span>{med.batch_no}</span>
                          </Col>
                        </Row>
                      </div>
