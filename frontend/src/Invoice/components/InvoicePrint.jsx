...
//   //   // Let the browser re-render before printing
//   //   setTimeout(() => {
//   //     window.print();
...
//   const handlePrint = () => {
//     document.body.classList.add(styles.printMode); // Use CSS module class
//     setTimeout(() => {
//       window.print();
...
const InvoicePrint = ({ show, handlePrintClose, patientId }) => {
  ...
  <div className={` d-flex  ${styles.headerContainer}`}>
    ...
    <div className={`ms-5 ${styles.hospitalInfo}`}>
      <h3 className={styles.title} style={{ color: '#A34C51' }}>
        Sai Teja Multi Speciality Hospital
      </h3>
      <h5 className="text-primary">(A UNIT OF SAVITHA HEALTH CARE PVT.LTD)</h5>
