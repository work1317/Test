...
const [pharmacyDates, setPharmacyDates] = useState({ from: null, to: null });  
 ...
 try {
   ...
   alert(error.response?.data?.message || "Failed to create invoice. Please try again.");
     ...
     <Card className={styles.card}>
       <Card.Body>
         ...
         <Row className={styles.totalRow}>
           ...
           <Col></Col>
          <Col><span>{calculateTotal()}</span></Col> 
         </Row>
         {/* Concession Input */}
         <h6 className="mt-1">Concession</h6>
         ...
         <Row className={styles.totalRow}>
           <Col><strong>Final Amount</strong></Col>
           <Col></Col>
           <Col><span>{calculateFinalAmount()}</span></Col>
         </Row>
       </Card.Body>
     </Card>
   </Col>
